...
## Summary
- 1318 nodes · 1758 edges · 110 communities (93 shown, 17 thin omitted)
...
- [[_COMMUNITY_Critical Rules|Critical Rules]]
- [[_COMMUNITY_Autonomous and Gated Modes (v3)|Autonomous and Gated Modes (v3)]]
- [[_COMMUNITY_Progress Log|Progress Log]]
- [[_COMMUNITY_caveman-stats|caveman-stats]]
- [[_COMMUNITY_Task Plan Brief Description|Task Plan: [Brief Description]]]
- [[_COMMUNITY_Claude Code Turn-Loop Integration (v2.38.0+)|Claude Code Turn-Loop Integration (v2.38.0+)]]
- [[_COMMUNITY_Task Plan Brief Description|Task Plan: [Brief Description]]]
...
### Community 1 - "mod.rs"
Cohesion: 0.07
Nodes (54): Color32, Default, DynamicImage, RgbImage, apply_smart_rotation(), cache_file_path(), cached_wallpaper_path(), cleanup_temp_files() (+46 more)

### Community 2 - "WallpaperApp"
Cohesion: 0.09
Nodes (33): App, Arc, AtomicBool, CreationContext, Drop, FnOnce, Frame, HWND (+25 more)
...
Cohesion: 0.11
Nodes (30): ChaChaRng, Duration, JoinHandle, Receiver, RegKey, Sender, pick_random_with_rng(), Option (+22 more)
...
Cohesion: 0.13
Nodes (15): Advanced Topics, Anti-Patterns, File Purposes, FIRST: Restore Context (v2.2.0), Important: Where Files Go, Parallel task workflow, Planning with Files, Quick Start (+7 more)
...
### Community 57 - "Critical Rules"
Cohesion: 0.25
Nodes (8): 1. Create Plan First, 2. The 2-Action Rule, 3. Read Before Decide, 4. Update After Act, 5. Log ALL Errors, 6. Never Repeat Failures, 7. Continue After Completion, Critical Rules

### Community 58 - "Autonomous and Gated Modes (v3)"
Cohesion: 0.25
...
### Community 62 - "Claude Code Turn-Loop Integration (v2.38.0+)"
Cohesion: 0.29
...
### Community 85 - "Security Boundary"
Cohesion: 0.67
Nodes (3): Security Boundary, Two layers of defense, v3 hardening

## Knowledge Gaps
- **609 isolated node(s):** `tempRoots`, `EventHandler`, `MockPi`, `MockContext`, `tempRoots` (+604 more)
